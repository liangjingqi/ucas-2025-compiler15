...
public:
  enum {
    ...
    T__32 = 33, T__33 = 34, NewLine = 35, WhiteSpace = 36, LineComment = 37, 
  ...
  enum {
    ...
    RuleFuncType = 9, RuleFuncParams = 10, RuleFuncParam = 11, RuleBlock = 12, 
    RuleBlockItem = 13, RuleStmt = 14, RuleExp = 15, RuleConstExp = 16, 
    RuleCond = 17, RuleLVal = 18, RuleFuncRParams = 19, RulePrimaryExp = 20, 
    RuleUnaryExp = 21, RuleMulExp = 22, RuleAddExp = 23, RuleRelExp = 24, 
    RuleEqExp = 25, RuleLAndExp = 26, RuleLOrExp = 27, RuleNumber = 28
  };
